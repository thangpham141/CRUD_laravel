    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <button type="button" class="close" id="close-update" data-dismiss="modal">&times;</button>
            </div>
            ...
            <div class="modal-body">
                ...
                @method('PUT')
                    ...
                    <div class="d-none"><input id="customer_id"></div>
                    ...
                    <button type="button" data-url="" class="btn btn-primary mb-2" name="update-customer" id="update-customer">Lưu</button>
                </form>
            </div>
